...
def adjust_results4_isadog(results_dic, dogfile):
    ...
    """           
    # Read the dog names from the dogfile into a dictionary or list
    ...
    # Iterate through the results dictionary and adjust the labels
    for key in results_dic:
        ...
        if any(label in dog_names_dict for label in classifier_label.split(',')):
            results_dic[key].append(1)
        else:
            results_dic[key].append(0)
